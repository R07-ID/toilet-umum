...
//
const BotName = 'R07BOT🤖'; // jangan di ubah...bila di ubah error.      BOT BY TN DJ4R07
const instagramlu = 'https://instagram.com/creator_official03'; // jangan di ubah...bila di ubah error dan lu nanti nangis
const whatsapplu = 'wa.me/6282328023356'; // jangan di ubah...bila di ubah nanti error nangis
const kapanbotaktif = 'Terserah aku kok'; // jangan di ubah...bila di ubah nanti error nangis
const grupch1 = 'https://chat.whatsapp.com/E8VriS0ojj53PX5wkhPYaD'; // jangan di ubah...bila di ubah nanti eror nangis
const grupch2 = 'https://chat.whatsapp.com/E8VriS0ojj53PX5wkhPYaD'; // jangan di ubah...bila di ubah nanti eror nangis
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] QR Code By Tn Djarot Ready to Scan`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] =>  bot by @Tn Djarot ID`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] =>  bot by @Tn Djarot ID`)
})
  ...
  var teks = text.replace(/%nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, 'Tunggu Sebentar Bot Sedang Menulis📝', MessageType.text)
...
conn.sendMessage(id, 'Wa.me/6282328023356' ,MessageType.text);
}
