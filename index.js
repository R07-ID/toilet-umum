...
//
const BotName = '➸R07 BOT 🤖'; // Nama Bot Whatsapp
...
const grupch1 = 'https://chat.whatsapp.com/KtYXP8oNw9NBxr3ltcwKyU'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/DsgXccfAg5r1uMRa33ZQaK'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] QR Code By Tn_Djarot Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @TN_DJAR07`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @TN_DJAR07`)
})
...
conn.sendMessage(id, 'Owner ridho wa.me/6282328023356' ,MessageType.text);
}
